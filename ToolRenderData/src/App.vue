...
export default {
  ...
  methods:{
    changeLayoutFunction: function(key){
      for (var i in this.listLayoutFunction) {
        if(i!=key){
          this.listLayoutFunction[i]=false;
        }
      }
      this.listLayoutFunction[key]=true;
    }
  }
}
</script>
...
background-image: linear-gradient(135deg, #60cff3 0%, #80D0C7 100%);
